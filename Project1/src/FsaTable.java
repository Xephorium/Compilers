...
public class FsaTable {
    ...
    private void setupFsaTable() {
         ...
         */
        //                  W    L    N    =    *    /    +    -    %    <    >    :    ;    .    ,    (    )    {    }    [    ]    O
        Integer a0[]  = {   0,   1,   2,   3,   5,   6,   7,   8,   9,  10,  11,  12,  14,  15,  16,  17,  18,  19,  20,  21,  22,  -1 }; // Initial State
        ...
        Integer a3[]  = { 503, 503, 503,   4, 503, 503, 503, 503, 503, 503, 503, 503, 503, 503, 503, 503, 503, 503, 503, 503, 503, 503 }; // =
        ...
        Integer a12[] = { 512, 512, 512,  13, 512, 512, 512, 512, 512, 512, 512, 512, 512, 512, 512, 512, 512, 512, 512, 512, 512, 512 }; // :
